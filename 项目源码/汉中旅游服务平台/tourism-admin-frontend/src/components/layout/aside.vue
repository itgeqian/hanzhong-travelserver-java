<template>
    <el-aside :width="isCollapse ? '64px' : '240px'">
        <div class="back-icon" :style="{width: isCollapse ? '63px' : '239px'}">
          <h1 style="font-size: 20px;color:white">汉中旅游服务平台-管理端</h1>
        </div>
        <el-menu
            @select="handleSelect"
            :collapse="isCollapse"
            ...
            >
                ...
                <el-menu-item index="/food@美食推荐">
                    <i class="el-icon-food"></i>
                    <span slot="title">美食推荐</span>
                </el-menu-item>
                <el-menu-item index="/culture@汉文化活动">
                    <i class="el-icon-trophy"></i>
                    <span slot="title">汉文化活动</span>
                </el-menu-item>
                <el-menu-item index="/contact@联系我们">
                    <i class="el-icon-phone"></i>
                    <span slot="title">联系我们</span>
                </el-menu-item>
                <el-menu-item index="/message@用户留言">
