        ...
        <div class="search">
            <el-row :gutter="10" style="padding:10px">
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <span class="search-title">美食名称:</span>
                    <el-input
                ...
                <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
                    <span class="search-title">美食类型:</span>
                    <el-input
                        style="margin-top:10px"
                        size="mini"
                        placeholder="请输入美食类型"
        ...
        <div class="table">
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                  <el-rate v-model="scope.row.recommendLevel" disabled show-score text-color="#ff9900"></el-rate>
              </template>
            </el-table-column>
            <el-table-column
              prop="state"
...
<script>
  import add from '../../../components/system/food/addFood'
  import update from '../../../components/system/food/updateFood'
  import {getSysFoodPage,removeSysFood,editSysFood} from '../../../api/api' 
  export default {
    data() {
      return{
        loading: true,
    ...
    methods: {
      ...
      deleteDataBtn() {
        this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
          ...
          removeSysFood({ids:ids}).then(res => {
            if(res.code == 1000) {
              this.$notify({
                title: '成功',
                message: '删除成功',
